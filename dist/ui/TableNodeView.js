...
var TableView = function TableView(node, cellMinWidth) {
  ...
  (0, _prosemirrorTables.updateColumnsOnResize)(node, this.colgroup, this.table, cellMinWidth);
...
TableView.prototype.update = function update(node) {
  ...
  this.node = node;
  (0, _prosemirrorTables.updateColumnsOnResize)(node, this.colgroup, this.table, this.cellMinWidth);
  return true;
};
